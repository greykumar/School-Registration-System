...
import gkumar_hw4.exception.SectionNotFoundException;
...
public class Driver {
    ...
    private static void printSystem(RegistrationSystem system) {
       ...
       for(String key : RegistrationSystem.getFaculty().keySet() ) {
      	 System.out.println(RegistrationSystem.getFaculty().get(key));
       }
       System.out.println();
       System.out.println();
       System.out.println("--STUDENT LIST--");
       for(String key : system.getStudent().keySet() ) {
      	 System.out.println(system.getStudent().get(key));
       }
       
       System.out.println();
       System.out.println();
       System.out.println("--SUBJECT LIST--");
       for(SubjectCode key : system.getSubject().keySet() ) {
      	 System.out.print("Subject: ");
      	 System.out.println(system.getSubject().get(key));
       }
       
       System.out.println();
       System.out.println();
       System.out.println("--COURSE LIST--");
       for(String key : system.getCourse().keySet() ) {
      	 System.out.println(system.getCourse().get(key));
       }
       
       System.out.println();
       System.out.println();
       System.out.println("--SECTION LIST--");
       for(String key : system.getSection().keySet() ) {
      	 System.out.println(system.getSection().get(key));
       }
    }
